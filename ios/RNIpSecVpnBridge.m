...
RCT_EXTERN_METHOD(saveConfig:(NSString *)name address:(NSString *)address username:(NSString *)username password:(NSString *)password secret:(NSString *)secret disconnectOnSleep:(BOOL)disconnectOnSleep findEventsWithResolver:(RCTPromiseResolveBlock)findEventsWithResolver rejecter:(RCTPromiseRejectBlock)rejecter)
